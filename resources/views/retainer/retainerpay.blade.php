                ...
                <div class="all-button-box mr-3">
                    ...
                    @if ($retainer->getDue() > 0)
                        ...
                        <a href="#" class="btn btn-xs btn-primary btn-icon-only width-auto"
                            title="{{ __('Pay Now') }}" data-bs-toggle="modal" data-bs-target="#paymentModal"><i
                                class="fas fa-plus"></i> {{ __('Pay Now') }}</a>
                                        ...
                                        @if (
                                            ...
                                            <li class="nav-item mb-2">
                                                ...
                                                <button class=" btn btn-outline-success btn-sm" id="pills-home-tab"
                                                    ...
                                                    type="button" role="tab" aria-controls="pills-home"
                                                    aria-selected="true" onclick=get_payfast_status()>{{ __('Payfast') }}</button>
                                            </li>
                                        @endif
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    @if (
                                        ...
                                        <div class="tab-pane fade active show" id="stripe-payment" role="tabpanel"
                                            ...
                                            <form method="post"
                                                action="{{ route('retainer.payment', $retainer->id) }}"
