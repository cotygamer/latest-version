                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                                <div class="btn-box">
                                    {{ Form::date('bill_date', isset($_GET['bill_date'])?$_GET['bill_date']:date('Y-m-d'), array('class' => 'month-btn form-control','id'=>'pc-daterangepicker-1', 'placeholder' => 'YYYY-MM-DD')) }}
                            ...
                            <tbody>
                                @foreach ($bills as $bill)
                                    <tr>
                                        ...
                                        <td>
                                            @if($bill->status == 0)
                                                <span class="badge fix_badges bg-secondary p-2 px-3 rounded">{{ __(\App\Models\Invoice::$statues[$bill->status]) }}</span>
