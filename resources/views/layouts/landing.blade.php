...
<head>
    ...
    <title>
        {{ \App\Models\Utility::getValByName('title_text') ? \App\Models\Utility::getValByName('title_text') : config('app.name', 'AccountGo SaaS') }}
        ...
        <div class="container">
            <a class="navbar-brand bg-transparent" href="#">
                <img src="{{ $logo . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-dark.png') }}"
                    alt="{{ config('app.name', 'AccountGo') }}" class="logo logo-lg" style="width: 210px">
            </a>
                ...
                <div class="col-sm-5">
                    ...
                    <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                        <a href="{{ route('login') }}" class="btn btn-light me-2"><i class="far fa-eye me-2"></i>Live
                            Demo</a>
                        <a href="https://codecanyon.net/item/accountgo-saas-accounting-and-billing-tool/25733019?s_rank=27"
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12 text-end">
                    <p class="text-body">
                        {{ \App\Models\Utility::getValByName('footer_text') ? \App\Models\Utility::getValByName('footer_text') : __('Copyright AccountGo SaaS') }}
                        {{ date('Y') }}</p>
                </div>
            </div>
        </div>
