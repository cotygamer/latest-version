...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::date('purchase_date',date('Y-m-d'), array('class' => 'form-control pc-datepicker-1')) }}
        </div>
        <div class="form-group col-md-6">
            {{ Form::label('supported_date', __('Supported Date'),['class'=>'form-label']) }}
            {{ Form::date('supported_date',date('Y-m-d'), array('class' => 'form-control pc-datepicker-1')) }}
        </div>
