            ...
            <ul class="dash-navbar">
                    ...
                    @if( Gate::check('manage user') || Gate::check('manage role'))
                        <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'users' || Request::segment(1) == 'roles' || Request::segment(1) == 'permissions' )?' active dash-trigger':''}}">
                            ...
                            <ul class="dash-submenu {{ (Request::segment(1) == 'users' || Request::segment(1) == 'roles' || Request::segment(1) == 'permissions')?'show':''}}">
                                ...
                                @endcan
                                {{-- <li class="dash-item {{ (Request::route()->getName() == 'logs.index' || Request::route()->getName() == 'logs.create' || Request::route()->getName() == 'logs.edit') ? ' active' : '' }}">
                                    <a class="dash-link" href="{{route('userlogs.index')}}">{{ __('User Logs') }}</a>
                                </li> --}}
                            </ul>
                        </li>
                    @endif
                ...
                <li class="dash-item {{ (Request::segment(1) == 'Notifications')?'active':''}}">
                    <a href="{{ route('notification-templates.index') }}" class="dash-link"><span
                            class="dash-micon"><i class="ti ti-bell"></i></span><span class="dash-mtext">{{__('Notification Template')}}</span></a>
                </li>
                @endif
