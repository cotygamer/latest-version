        ...
        try {
            $payments = RetainerPayment::create(
                [
                    ...
                    'receipt' => '',
                    'reference' => '',
                    'description' => 'Retainer ' . Utility::invoiceNumberFormat($settings, $retainer->retainer_id),
                ]
            );
            ...
            $retainerPayment->description = 'Retainer ' . Utility::invoiceNumberFormat($settings, $retainer->invoice_id);
